#  This is a fork of the original Russian Roulette cog created by Redjumpman
...
class Russianroulette:
    ...
    def __init__(self, bot):
        self.bot = bot
        self.file_path = "data/fedocogs/roulette/russian.json"
...
def check_folders():
    if not os.path.exists("data/fedocogs/roulette"):
        print("Creating data/fedocogs/roulette folder...")
        os.makedirs("data/fedocogs/roulette")


def check_files():
    system = {"Servers": {}}

    f = "data/fedocogs/roulette/russian.json"
